<?php 
 $products = $conn->query("SELECT p.*,b.name as bname FROM `products` p inner join brands b on p.brand_id = b.id where p.id = '{$_GET['id']}' ");
    ...
    <div class="container px-4 px-lg-5 mt-5">
        ...
        ?>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 mb-3 d-flex align-items-stretch">
                <a class="card h-100 product-item text-dark w-100" href=".?p=view_product&id=<?php echo $row['id'] ?>">
                    <!-- Product image-->
                    <img class="card-img-top w-100" style="max-width: 100%;height:8rem !important" src="<?php echo validate_image($img) ?>" alt="..." />
                    <!-- Product details-->
